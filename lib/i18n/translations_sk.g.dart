...
class TranslationsSk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String scheduleFrequencyEveryNDays({required num count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sk'))(count,
		few: 'Každé ${count} dni',
	...
	@override String remaining({required num count, required Object unit}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sk'))(count,
...
extension on TranslationsSk {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'scheduleFrequencyEveryNDays' => ({required num count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sk'))(count, few: 'Každé ${count} dni', other: 'Každých ${count} dní', ), 
			...
			'remaining' => ({required num count, required Object unit}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sk'))(count, few: 'Zostávajú ${count} ${unit}', other: 'Zostáva ${count} ${unit}', ), 
