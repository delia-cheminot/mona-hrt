...
class TranslationsUk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String scheduleFrequencyEveryNDays({required num count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uk'))(count,
	...
	@override String remaining({required num count, required Object unit}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uk'))(count,
...
extension on TranslationsUk {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'scheduleFrequencyEveryNDays' => ({required num count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uk'))(count, other: 'Кожні ${count} днів', ), 
			...
			'remaining' => ({required num count, required Object unit}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uk'))(count, other: '${count} ${unit} залишилось', ), 
